<?php if (!is_page('nikai')) : ?>
	...
	<?php else :?>
			<footer class="footer">
		<div class="footer-bg footer-nikai-bg"></div>
		<div class="contents-wrapper">
			<div class="footer-content fade-in">
				<div class="footer-contact">
					<p class="footer-contact-title">
					...
					<div class="footer-contact-body">
						...
						<div>
							<div class="footer-tel header-nav-contact">
								<a href="<?php echo esc_url(home_url('/contact/')); ?>">
									...
									<div class="header-nav-contact-body">
										<span class="header-nav-tel">0266-75-5803</span>
										<span class="header-nav-time">営業時間&emsp;18：00〜22：00</span>
									</div>
								</a>
							</div>
						...
						<p class="
				contact-seat footer-contact-seat">席数：3~4人掛けテーブル3つ・6人掛けテーブル3つ</p>
						<p class="contact-parking footer-contact-parking">駐車場：あり（6台）</p>
						<p class="contact-payment footer-contact-payment">お支払い：各種クレジットカード、交通系IC、PayPay</p>
					</div>
					<div class="footer-contact-button botton-white">
						<a href="<?php echo esc_url(home_url('/contact/')); ?>">
							contact
				...
				<div class="footer-bottom">
					<div class="footer-bottom-logo footer-bottom-logo-nikai">
						<a href="<?php echo esc_url(home_url('/')); ?>">
							<img src="<?php echo get_template_directory_uri(); ?>/images/assets/nikai-logo.png" alt="nikaiロゴ">
						</a>
					</div>
					<div class="footer-bottom-instagram footer-bottom-instagram-nikai">
						<a href="https://www.instagram.com/horumon_nikai/" target="_blank" rel="noopener noreferrer">
							<img src="<?php echo get_template_directory_uri(); ?>/images/assets/instagram-icon.svg" alt="インスタグラムアイコン">
						</a>
					</div>
				</div>
